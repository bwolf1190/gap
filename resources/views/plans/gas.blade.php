<div class="container">
    <div class="row">
        ...
        <li class="inactive tab"><a id="electric-link" href="/web/select-plan/{{ $plans[0]->type }}/{{ $plans[0]->ldc }}/Electric">Electric</a></li>
        <li class="active tab"><a id="gas-link" href="/web/select-plan/{{ $plans[0]->type }}/{{ $plans[0]->ldc }}/Gas">Natural Gas</a></li>
        </ul>  

        <div class="tab-content">
            <div id="gas" class="fade in active">
                @foreach($plans as $plan)
                    ...
                    @endif      
                        <div class="price_table_container">
                            ...
                            <div class="price_table_heading commodity">Natural {!! $plan->commodity !!}</div>
