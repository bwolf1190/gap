...
class LdcByZipCodeTest extends TestCase
{
    ...
    public function zip_code_returns_duke()
    {
		...
		$response = '<soap:Envelope xmlns:soap="http://schemas.xmlsoap.org/soap/envelope/" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsd="http://www.w3.org/2001/XMLSchema">
		   <soap:Body>
		      <ExecuteSPResponse xmlns="http://www.opsolve.com/RS/webservices/">
		         <ExecuteSPResult>
		            <string><![CDATA[<?xml version="1.0" standalone="yes" ?>
				<ReadiSystem>
				<RS_sp_DR_Offers_By_Zip>
				<entno>4270</entno>
				<offer_name>OHDUKE_RES</offer_name>
				<offer_desc>Duke Energy - Ohio - Residential</offer_desc>
				<supno>DUKE_OH</supno>
				<rev_type>R</rev_type>
				<utility_type>E</utility_type>
				<state_id>OH</state_id>
				</RS_sp_DR_Offers_By_Zip>
				</ReadiSystem>]]></string>
		         </ExecuteSPResult>
		      </ExecuteSPResponse>
